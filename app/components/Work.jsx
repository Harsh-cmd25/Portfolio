...
const Work = () => {
  ...
  return (
    ...
    >
      ...
      >
        Passionate about software development with expertise in Full-Stack Web
        Development and Machine Learning. Developed full-stack platforms using
        the MERN stack (MongoDB, Express.js, React.js, Node.js) with a focus on
      ...
      >
        {workData.map((projects, index) => (
          <motion.div
            ...
            key={index}
            style={{ backgroundImage: `url(${projects.bgImage.src})` }}
          >
            <div
