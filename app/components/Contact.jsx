...
const Contact = () => {
  ...
  const onSubmit = async (event) => {
    ...
    formData.append("access_key", "19f7025e-0d70-47c3-af2f-0d5cc82c85e0");
    ...
    >
      ...
      >
        <div className="grid grid-cols-[repeat(auto-fit,_minmax(200px,_1fr))] gap-6 mt-10 mb-8">
          <motion.input
            ...
            className={`flex-1 p-3 outline-none border-[0.5px]  rounded-md  ${
              isDarkMode
                ? "bg-[rgba(42,0,74,0.3)] border-white"
        ...
        <motion.textarea
          ...
          required
          className={`w-full p-4 outline-none border-[0.5px] rounded-md ${
            isDarkMode
              ? "bg-[rgba(42,0,74,0.3)] border-white "
        ...
        <motion.button
          ...
          className={`py-3 px-8 w-max flex items-center justify-between gap-2 rounded-full mx-auto duration-500 
                    ${
                      isDarkMode
                        ? "bg-transparent border-[0.5px] hover:bg-[#2a004a]"
                        : " hover:bg-[#2a004a]  bg-black/80  text-white "
                    }`}
        >
          {" "}
          Submit Now
