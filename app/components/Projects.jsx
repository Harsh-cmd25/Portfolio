...
const Projects = () => {
  ...
  return (
    ...
    >
      ...
      >
        Experienced in Web Development, Data Structures & Algorithms (DSA),
        Machine Learning (ML) and Competitive Programming (CP). Proficient in
        building scalable applications, solving complex problems, and optimizing
